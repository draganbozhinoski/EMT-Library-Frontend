                        ...
                        return(
                            <tr>
                                ...
                                <td><button className={"btn btn-primary btn-sm"}>Edit</button>-
                                    <button className={"btn btn-danger btn-sm"} onClick={() => this.deleteBook(book.id)}>Delete</button>-
                                    <button className={"btn btn-success btn-sm"} onClick={() => this.takeBook(book.id)}>Mark as taken</button>
                                </td>
                            </tr>
                        );
                    })}
